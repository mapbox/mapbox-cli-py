...
mock_response_200 = responses.Response(
    ...
    "/analytics/v1" +
    "/accounts/mapbox-user" +
    "?access_token=mapbox-token" +
    "&period=2018-04-15T00%3A00%3A00.000Z%2C2018-04-16T00%3A00%3A00.000Z",
...
def test_cli_analytics_invalid_date_long_options():
    runner = CliRunner()
    ...
    assert result.exit_code != 0
    assert "ISO formatted string" in result.output


def test_cli_analytics_invalid_date_short_options():
    runner = CliRunner()
